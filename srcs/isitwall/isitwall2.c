...
/*   Updated: 2019/11/29 11:44:19 by pganglof         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (gamer->facing_up)
		*(float*)(wall_hor->unity) = (float)(*(int*)(gamer->unity)
		/ BLOCK_SIZE) * (BLOCK_SIZE) - 1;
	else
		*(float*)(wall_hor->unity) = (float)((*(int*)(gamer->unity) / BLOCK_SIZE)
		* (BLOCK_SIZE) + BLOCK_SIZE);
	*(float*)(wall_hor->unitx) = (float)(*(int*)(gamer->unitx)
