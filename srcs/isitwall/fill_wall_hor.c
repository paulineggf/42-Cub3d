...
/*   Updated: 2019/12/02 21:47:19 by pganglof         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fill_wall_hor(t_map *map, t_pos *wall_hor)
{
	if (map->gamer->facing_up)
		...
		wall_hor->unity = (double)((map->gamer->posy * BLOCK_SIZE) + BLOCK_SIZE);
	wall_hor->unitx = (double)(map->gamer->unitx + (map->gamer->unity - wall_hor->unity) /
